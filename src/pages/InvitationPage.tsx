...
export default function InvitationPage() {
  ...
  const validateInvitation = async () => {
    ...
    try {
      ...
      if (new Date(foundInvitation.expiresAt ?? foundInvitation.expires_at) < new Date()) {
        setExpired(true);
        ...
        <CardContent className="space-y-6">
          ...
          <div className="bg-blue-50 p-4 rounded-lg">
            ...
            <div className="space-y-1 text-sm">
              ...
              <p><strong>Rol:</strong> {invitation.role ?? invitation.role_id ?? 'Sin rol'}</p>
              <p><strong>Invitado por:</strong> {invitation.invitedBy ?? invitation.invited_by ?? 'Sistema'}</p>
              <p><strong>Expira:</strong> {new Date(invitation.expiresAt ?? invitation.expires_at).toLocaleDateString('es-ES')}</p>
            </div>
            {invitation.message && (
