...
class FileService {
  ...
  // FunciÃ³n simplificada - no verificar bucket
  ...
  async uploadFile(
    ...
    try {
      ...
      toast({
        title: 'âŒ Error al subir archivo',
  ...
  async getProjectFiles(
    ...
    try {
      ...
      toast({
        title: 'âŒ Error al cargar archivos',
  ...
  async downloadFile(fileId: string): Promise<Blob> {
    try {
      ...
      toast({
        title: 'âŒ Error al descargar archivo',
  ...
  // Actualizar archivo (nueva versiÃ³n)
  async updateFile(
    fileId: string,
    newFile: File,
    metadata?: any
    ...
    try {
      ...
      toast({
        title: 'âŒ Error al actualizar archivo',
  ...
  async createFolder(
    ...
    try {
      ...
      // Crear archivo vacÃ­o para representar la carpeta
      ...
      toast({
        title: 'âŒ Error al crear carpeta',
