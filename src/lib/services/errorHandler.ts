...
export class AppErrorHandler {
  ...
  handleSupabaseError(error: unknown, context: string = 'Operacion'): void {
  ...
  public handleGenericError(error: unknown, context: string): void {
...
export const handleSupabaseError = (error: unknown, context: string = 'Operacion') => {
