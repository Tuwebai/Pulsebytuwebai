...
export const DEFAULT_WORKFLOWS: TicketWorkflow[] = [
  {
    ...
    description: 'Workflow estÃ¡ndar para tickets de soporte general',
    isDefault: true,
    isActive: true,
    stages: [
      {
...
class TicketWorkflowService {
  ...
  // LÃ³gica de Transiciones AutomÃ¡ticas
  ...
  private async executeAssignment(rule: AutoAssignmentRule, ticketData: any): Promise<string | null> {
    // Implementar lÃ³gica de asignaciÃ³n segÃºn el tipo
    ...
    for (const action of rule.actions) {
      switch (action.type) {
        ...
        case 'update_priority':
          ...
          break;
        case 'create_task':
          // Implementar creaciÃ³n de tarea
          break;
        case 'send_email':
  ...
  private async executeTransition(ticketData: any, transition: AutoTransitionRule): Promise<void> {
    // Implementar transiciÃ³n automÃ¡tica
