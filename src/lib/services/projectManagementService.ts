...
class ProjectManagementService {
  ...
  /**
   * Obtener tareas de una fase especÃ­fica
   */
  ...
  /**
   * Obtener mÃ©tricas de un proyecto
   */
  async getProjectMetrics(projectId: string): Promise<ProjectMetrics[]> {
    try {
      ...
      console.error('Error obteniendo mÃ©tricas del proyecto:', error);
      throw error;
    }
  }
  ...
  /**
   * Obtener progreso de proyecto usando funciÃ³n SQL
   */
