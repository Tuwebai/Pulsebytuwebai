...
export const EMAIL_TEMPLATES = {
  ...
  SUPPORT_TICKET_ADMIN: (data: {
    ...
    <head>
        ...
        <title>Nuevo Ticket de Soporte - Pulse by TuWebAI</title>
        <style>
  ...
  TICKET_CONFIRMATION_CLIENT: (data: {
    ...
    <head>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Ticket Recibido - Pulse by TuWebAI</title>
        <style>
            body { font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; margin: 0; padding: 0; background: #f8fafc; }
            .container { max-width: 600px; margin: 0 auto; background: white; }
  ...
  TICKET_RESPONSE_CLIENT: (data: {
    ...
    <head>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Respuesta a tu Ticket - Pulse by TuWebAI</title>
        <style>
            body { font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; margin: 0; padding: 0; background: #f8fafc; }
            .container { max-width: 600px; margin: 0 auto; background: white; }
                    ...
                    <div class="admin-signature">
                        <div style="display: flex; align-items: center;">
                            ...
                            <div>
                                ...
                                <span style="color: #6b7280; font-size: 14px;">Equipo de Pulse by TuWebAI</span>
                            </div>
                        </div>
                    </div>
                </div>
  ...
  DAILY_SUMMARY_ADMIN: (data: {
    ...
    <head>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Resumen Diario - Pulse by TuWebAI</title>
        <style>
            body { font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; margin: 0; padding: 0; background: #f8fafc; }
...
export const userInvitationTemplate = {
  subject: 'Invitacion para unirte a Pulse by TuWebAI',
  html: `
    <!DOCTYPE html>
    <html>
    <head>
      <meta charset="utf-8">
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
      <title>Invitacion Pulse by TuWebAI</title>
      <style>
    ...
    <body>
      <div class="container">
        <div class="header">
          ...
          <p>Te invitamos a unirte al equipo de Pulse by TuWebAI</p>
        </div>
        
        <div class="content">
          <h2>Hola,</h2>
          
          <p>Has recibido una invitacion para unirte a <strong>Pulse by TuWebAI</strong> como <strong>{{role}}</strong>.</p>
        ...
        <div class="footer">
          <p>Pulse by TuWebAI · Tu web, en numeros reales.</p>
  ...
  `,
  text: `
    ¡Has sido invitado a unirte a Pulse by TuWebAI!
    
    Hola,
    
    Has recibido una invitacion para unirte a Pulse by TuWebAI como {{role}}.
