...
export class DatabaseMigrations {
  ...
  async createHelperFunctions(): Promise<MigrationResult[]> {
    ...
    try {
      ...
      results.push({
        success: !func1,
        message: func1 ? `Error creando funciÃ³n update_updated_at_column: ${func1.message}` : 'FunciÃ³n update_updated_at_column creada exitosamente'
      });

      // FunciÃ³n para obtener estadÃ­sticas de proyecto
      ...
      results.push({
        success: !func2,
        message: func2 ? `Error creando funciÃ³n get_project_stats: ${func2.message}` : 'FunciÃ³n get_project_stats creada exitosamente'
      });
      ...
      results.push({
        success: !func3,
        message: func3 ? `Error creando funciÃ³n get_user_stats: ${func3.message}` : 'FunciÃ³n get_user_stats creada exitosamente'
      });
