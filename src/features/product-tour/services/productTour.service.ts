...
export const PRODUCT_TOUR_STEPS: ProductTourStep[] = [
  ...
  },
  {
    ...
    tabValue: 'datos',
    title: 'Aca guardas tu informacion personal',
    description: 'Este formulario concentra nombre, telefono y tu email de acceso dentro de Pulse.',
    placement: 'top',
  },
  {
  ...
  },
  {
    ...
    tabValue: 'seguridad',
    title: 'Desde aca cambias tu contrasena',
    description: 'Pulse separa este cambio para que sea claro, directo y facil de confirmar.',
    placement: 'top',
  },
  {
    ...
    tabValue: 'seguridad',
    title: 'Tambien podes cerrar todas tus sesiones',
    description: 'Si sospechas un acceso raro, este bloque te deja reiniciar la sesion en todos tus dispositivos.',
    placement: 'top',
  },
  {
  ...
  },
  {
    ...
    tabValue: 'cuenta',
    title: 'La zona de peligro esta aislada a proposito',
  ...
  },
  {
    ...
    tabValue: 'general',
    title: 'Este resumen te ubica rapido',
    description: 'Aca ves tu identidad principal, el sitio vinculado y el estado general de la cuenta.',
    placement: 'bottom',
  },
  {
  ...
  },
  {
    ...
    tabValue: 'rendimiento',
    title: 'Estos controles si impactan tu experiencia real',
    description: 'Desde aca ajustas comportamiento visual y rendimiento dentro del dashboard.',
    placement: 'top',
  },
  {
  ...
  },
  {
    ...
    tabValue: 'notificaciones',
    title: 'Aca defines que avisos queres recibir',
    description: 'Pulse te deja elegir novedades de consultas, resumenes y avances del proyecto.',
    placement: 'top',
  },
  {
  ...
  },
  {
    ...
    tabValue: 'seguridad',
    title: 'El control de sesion vive aca',
    description: 'Este bloque te deja decidir cuanto tiempo mantener activa la sesion en este dispositivo.',
    placement: 'top',
  },
  {
    id: 'project-header',
