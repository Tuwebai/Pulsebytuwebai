  ...
  return (
    <Dialog open={open} onOpenChange={(nextOpen) => !nextOpen && onClose()}>
      <DialogContent className="max-w-3xl border-white/10 bg-[var(--bg-surface)] p-0 text-slate-100">
        <div className="rounded-[inherit] border border-white/10 bg-[linear-gradient(180deg,rgba(123,76,212,0.12),rgba(8,15,30,0.97)_28%)] p-6">
          <DialogHeader className="mb-6 space-y-2 text-left">
            <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-violet-300">Pulse admin · respuesta</p>
            <DialogTitle className="text-2xl text-slate-50">Responder ticket</DialogTitle>
            <DialogDescription className="text-sm leading-6 text-slate-400">
              Redactá una respuesta clara, humana y accionable para que el cliente entienda el próximo paso.
            </DialogDescription>
          </DialogHeader>

          {ticket ? (
            <div className="mb-5 rounded-[24px] border border-white/10 bg-[var(--bg-base)]/80 p-4">
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              placeholder="Contá qué revisó el equipo y qué sigue ahora."
