    ...
    <div className="space-y-5">
      ...
      <dl className="grid gap-3 sm:grid-cols-2">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-4">
          ...
          <dd className="mt-2 break-all text-sm text-[var(--text-primary)]">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-4">
          ...
          <dd className="mt-2 text-sm text-[var(--text-primary)]">{formatOperationalDate(project.start_date || project.created_at)}</dd>
        </div>
        ...
        <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-4">
          ...
          <dd className="mt-2 text-sm text-[var(--text-primary)]">{formatOperationalDate(project.updated_at)}</dd>
        </div>
      </dl>
    </div>
  );
