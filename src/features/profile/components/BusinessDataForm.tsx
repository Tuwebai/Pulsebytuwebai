...
import { BUSINESS_INDUSTRY_OPTIONS } from '@/features/profile/constants/profile.constants';
    ...
    <section className="rounded-[var(--radius-xl)] border border-[var(--border-default)] bg-[var(--bg-surface)] p-6">
      <div className="mb-5">
        ...
        <p className="mt-1 text-[13px] text-[var(--text-secondary)]">
          Esto nos ayuda a contextualizar mejor tu información dentro de Pulse.
        </p>
      </div>
      ...
      <form className="space-y-4" onSubmit={form.handleSubmit(onSubmit)}>
          ...
          <Controller
            ...
            render={({ field }) => (
              <Select value={field.value} onValueChange={field.onChange}>
                <SelectTrigger id="business_industry">
        ...
        <div className="space-y-2">
          ...
          <Input disabled id="website" value={website ?? ''} />
