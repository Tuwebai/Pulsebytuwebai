...
import { useNotificationAnalytics, type AnalyticsFilters } from '@/hooks/useNotificationAnalytics';

// =====================================================
// INTERFACES
// =====================================================

// AnalyticsFilters ahora se importa del hook
...
export default function NotificationAnalyticsDashboard() {
  ...
  const { 
    ...
    isLoading, 
    refetch 
  } = useNotificationAnalytics(filters);
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(groupBy) => updateFilters({ groupBy: groupBy as AnalyticsFilters['groupBy'] })}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold">{data?.summary.totalSent.toLocaleString()}</p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold">{data?.summary.deliveryRate.toFixed(1)}%</p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold">{data?.summary.openRate.toFixed(1)}%</p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold">{data?.summary.clickRate.toFixed(1)}%</p>
                </div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <Badge variant="outline">{data?.insights.bestPerformingChannel}</Badge>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-sm">Mejor Categoría:</span>
                    <Badge variant="outline">{data?.insights.bestPerformingCategory}</Badge>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-sm">Hora Pico:</span>
                    <Badge variant="outline">{data?.insights.peakSendingTime}</Badge>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-1">
                      {data?.insights.trends.deliveryRate === 'increasing' ? (
                        <TrendingUp className="h-4 w-4 text-green-500" />
                      ) : data?.insights.trends.deliveryRate === 'decreasing' ? (
                        <TrendingDown className="h-4 w-4 text-red-500" />
                      ) : (
                        <div className="h-4 w-4 bg-gray-400 rounded-full" />
                      )}
                      <span className="text-sm capitalize">{data?.insights.trends.deliveryRate}</span>
                    </div>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-sm">Apertura:</span>
                    <div className="flex items-center gap-1">
                      {data?.insights.trends.openRate === 'increasing' ? (
                        <TrendingUp className="h-4 w-4 text-green-500" />
                      ) : data?.insights.trends.openRate === 'decreasing' ? (
                        <TrendingDown className="h-4 w-4 text-red-500" />
                      ) : (
                        <div className="h-4 w-4 bg-gray-400 rounded-full" />
                      )}
                      <span className="text-sm capitalize">{data?.insights.trends.openRate}</span>
                    </div>
                  </div>
                </div>
              </div>
