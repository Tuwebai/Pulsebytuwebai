...
import { useApp, type User as AppUser } from '@/contexts/AppContext';
      ...
      try {
        const commentsWithReplies = await Promise.all(
          comments.map(async (comment) => {
            ...
            const commentReplies = replies.filter((reply: Comment) => reply.parent_id === comment.id);
  ...
  return (
    <div className="space-y-6">
      ...
      <ConfirmationDialog
        ...
        description="Estas seguro de que quieres eliminar este comentario? Esta accion no se puede deshacer."
      ...
      <CardContent className="p-4">
        <div className="flex gap-3">
          <Avatar className="h-10 w-10 flex-shrink-0">
            <AvatarImage src={comment.author_id === currentUser?.email ? (currentUser?.avatar ?? undefined) : undefined} />
            <AvatarFallback>
